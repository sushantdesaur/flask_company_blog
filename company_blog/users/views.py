...
def account():
    ...
    return render_template('users/accounts.html', profile_image=profile_image, form=form)
...
def user_posts(username):
    ...
    return render_template('users/user_blog_posts.html', blog_posts, user=user)
